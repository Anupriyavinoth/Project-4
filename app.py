...
def streamlit_config():
    ...
    # page configuration
    page_icon_url = Image.open('C:/Users/vinoth/Desktop/New folder/airbnb_logo.png')
    ...
    st.markdown(f""" <style>.stApp {{
                        background:url("https://media.istockphoto.com/id/1227329047/photo/two-ampty-chairs-facing-magnificent-sunset-view-at-beach.jpg?s=612x612&w=0&k=20&c=z7HngBDSmIyrvduaiz5F9bVd9fblyRWb8AKe3pf09fY=");
                        background-size: cover}}
                     </style>""", unsafe_allow_html=True)
    # title and position
    st.markdown(f'<h1 style="color:red;text-align:center;">Airbnb Analysis</h1>',
                unsafe_allow_html=True)
    st.markdown(f'<h5 style="color:red;font-size:papyrus;">Airbnb delves into a comprehensive exploration of Airbnb data. Airbnb has revolutionized the travel and property management industry, making it crucial to analyze its data to gain insights into pricing, availability patterns, and location-based trends.</h5>',
                unsafe_allow_html=True)
...
class data_collection:
    connect_db = pymongo.MongoClient("mongodb+srv://anu:1234@cluster0.fjjwrem.mongodb.net/?retryWrites=true&w=majority")
    db = connect_db ['sample_airbnb']
...
class feature:
    ...
    def feature_analysis():
        ...
        plotly.line_chart(cancellation_policy, y='cancellation_policy', x='count', text='percentage', color='#5D9A96',
...
with st.sidebar:
    image_url = Image.open('C:/Users/vinoth/Desktop/New folder/airbnb_banner.jpg')
    st.image(image_url,width=200)

    option = option_menu(menu_title='Home', options=['Migrating to SQL', 'Features Analysis', 'Host Analysis', 'Exit'],
